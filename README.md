# 🦜 Parrot Runner — a playable and AI platform system that builds it, Tests it with Golden sets multi Agent agent verification  and validates it before publishing: later: collects and measure real-world ad performance for impovemnt. compares to rubric score" to "variant win-rate"  ** closing the loop from production back into generation. **
